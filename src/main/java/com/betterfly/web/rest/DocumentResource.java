...
/**
 * REST controller for managing {@link com.betterfly.domain.Document}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Document> result = documentRepository
            ...
            .map(
                existingDocument -> {
                    ...
                    if (document.getIntitule() != null) {
                        existingDocument.setIntitule(document.getIntitule());
                    }
                    ...
                    if (document.getPieceJointe() != null) {
                        existingDocument.setPieceJointe(document.getPieceJointe());
                    }
                    if (document.getPieceJointeContentType() != null) {
                        existingDocument.setPieceJointeContentType(document.getPieceJointeContentType());
                    }
                    if (document.getEnApplication() != null) {
                        existingDocument.setEnApplication(document.getEnApplication());
                    }
                    if (document.getAppouve() != null) {
                        existingDocument.setAppouve(document.getAppouve());
                    }
