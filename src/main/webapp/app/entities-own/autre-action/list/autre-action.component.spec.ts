...
describe('Component Tests', () => {
  describe('AutreAction Management Component', () => {
    let comp: AutreActionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AutreActionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.autreActions?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
