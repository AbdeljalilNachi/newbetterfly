  ...
  describe('AnalyseSST Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Action query and add missing value', () => {
        ...
        const action: IAction = { id: 16453 };
        analyseSST.action = action;

        const actionCollection: IAction[] = [{ id: 57380 }];
      ...
      it('Should call User query and add missing value', () => {
        const analyseSST: IAnalyseSST = { id: 456 };
        const delegue: IUser = { id: 81737 };
        analyseSST.delegue = delegue;

        const userCollection: IUser[] = [{ id: 97913 }];
      ...
      it('Should call ProcessusSMI query and add missing value', () => {
        const analyseSST: IAnalyseSST = { id: 456 };
        const processus: IProcessusSMI = { id: 60109 };
        analyseSST.processus = processus;

        const processusSMICollection: IProcessusSMI[] = [{ id: 44041 }];
      ...
      it('Should update editForm', () => {
        const analyseSST: IAnalyseSST = { id: 456 };
        const action: IAction = { id: 208 };
        analyseSST.action = action;
        const delegue: IUser = { id: 17478 };
        analyseSST.delegue = delegue;
        const processus: IProcessusSMI = { id: 46641 };
        analyseSST.processus = processus;
